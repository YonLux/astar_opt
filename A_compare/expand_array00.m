function exp_array=expand_array00(node_x,node_y,hn,xTarget,yTarget,CLOSED,MAX_X,MAX_Y)
             ...
             if (k~=j || k~=0)  
                ...
                if( (s_x >0 && s_x <=MAX_X) && (s_y >0 && s_y <=MAX_Y))%node within array bound
                    ...
                    if (flag == 1)
                        ...
                        exp_array(exp_count,4) = 0;%distance between node and goal
                        exp_array(exp_count,5) = exp_array(exp_count,3);%fn
